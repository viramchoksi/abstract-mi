  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 max-w-[1120px] mx-auto px-5 lg:gap-x-5 gap-y-5 sm:mt-14 mt-10">
        <div className="shadow-box pb-14 rounded-2xl overflow-hidden border-[#222222] border-2">
          ...
          <div className="ml-[12%] flex gap-y-4 flex-col">
            ...
            <p className="text-2xl">
              {discover["Discover new apps"]}
              <br />
              {discover["that make your life easier"]}
            </p>
        ...
        <div className="col-span-2 grid grid-cols-2 gap-y-5 gap-x-5">
          <div className="lg:col-span-2 md:col-span-1 col-span-2 ">
            <div className="h-full w-full shadow-box-2 flex lg:flex-row flex-col items-center rounded-2xl border-[#222222] border-2">
              <Image
          ...
          <div className="lg:col-span-2 md:col-span-1 col-span-2 ">
            <div className="h-full w-full shadow-box flex lg:flex-row flex-col items-center rounded-2xl overflow-hidden">
              <Image
                src={discover.thirdContent.mobileImage}
                width={310}
                height={220}
                alt={discover.thirdContent.alt}
                className="sm:hidden block w-full mr-[-35px] "
              />
              <div className="flex flex-col gap-y-3 px-10 -ml-5 py-5">
                <p className="text-[#F1CE5B]">
              ...
              <Image
                src={discover.thirdContent.desktopImage}
                width={310}
                height={200}
                alt={discover.thirdContent.alt}
