  ...
  return (
    <div className={`${monaSans.className}`}>
      ...
      <div className='px-5 sm:px-0'>
        <button
          type='button'
          className='flex justify-center cursor-pointer  mx-auto text-black px-5 font-medium py-3 mt-12 gap-x-2 bg-[#68EDAD] hover:bg-[#4DD091] transition-all ease-in duration-150 rounded-md w-full sm:w-fit items-center'
        >
