  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="z-0 sm:min-h-[400px] min-h-[300px] sm:pt-14 pt-5">
        ...
        <p className="text-center max-w-[500px] md:hidden mt-5 text-[#6A7A7B] mx-auto h-full px-5">
          {t("header.description")}
        </p>
        <p className="text-center max-w-[580px] mt-5 text-[#6A7A7B] mx-auto h-full px-5 md:block hidden">
