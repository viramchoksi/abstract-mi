const allApps = [
  {
    title: "Equilibrium",
    description: "Autobalanced Portfolio",
    icon: "/images/equilibrium.svg",
  },
  {
    title: "Stake2Talk",
    description: "Get paid if someone wastes your time",
    icon: "/images/Stake2Talk.svg",
  },
  {
    title: "P4id",
    description: "Send payment requests in crypto",
    icon: "/images/P4id.svg",
  },
  {
    title: "Wallet Assist",
  ...
  {
    title: "Snackerino",
    description: "Cosmos Snacks",
    icon: "/images/Snackerino.svg",
  },
  {
    title: "Croncat",
    description: "1 click crypto automations",
    icon: "/images/Croncat.svg",
  },
];
...
export const siteData = {
  header: {
    ...
    title: (
      <p className="text-center sm:text-[56px] text-2xl sm:leading-[62px] mt-2">
        Personalized Apps <br />
        for Web3 Power Users
      </p>
    ),
    description:
      "It’s hard to find web3 apps that fit your exact needs. Abstract gives you personalized apps all in one place so you can save time and take back control over your web3 life.",
  },
  AllApps: {
    applications: [
      {
  ...
  discover: {
    ...
    description:
      "MINI APPS THAT SOLVE PROBLEMS SO YOU HAVE MORE TIME TO FOCUS ON WHAT MATTERS.",
    ...
    firstContent: {
      ...
      description:
        "Select from a variety of applications that enhance your daily crypto handling, from asset management to informed decision-making.",
    },
    secondContent: {
      subTitle: "PERSONALIZED DEFI",
      title: "Customized applications for your DeFi life",
      description:
        "Engage with applications that align with your financial strategies, providing tools for asset growth.",
    ...
    thirdContent: {
      ...
      description:
        "Using our pre-audited modules makes it easy and fast to build interchain apps.",
...
const redirectionJson = {
  Developers: {
    "On-Chain": {
      ...
      integrate:
        "https://docs.abstract.money/3_framework/6_module_types.html?highlight=adapter#adapters",
    },
    "Off-Chain": {
  ...
  Documentation: {
    "Get started building abstract apps":
      "https://www.youtube.com/@abstractmoney",
    ...
    Modules:
      "https://github.com/AbstractSDK/abstract/tree/main/modules/contracts",
    "Example apps":
      "https://github.com/AbstractSDK/abstract/tree/main/modules/contracts/apps",
